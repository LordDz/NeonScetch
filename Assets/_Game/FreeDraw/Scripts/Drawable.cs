...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        private void Start()
        {
            PenMarker = GameObject.FindObjectOfType<PenMarker>();
        }
        ...
        void Update()
        {
            ...
            bool isPainting = true; // = Input.GetMouseButton(0);
            if (isPainting && !no_drawing_on_current_drag)
            {
                // Convert mouse coordinates to world coordinates
                Vector2 mouse_world_position = Camera.main.ScreenToWorldPoint(PenMarker.transform.position);
            ...
            mouse_was_previously_held_down = isPainting;
        }
        ...
        public void MarkPixelsToColour(Vector2 center_pixel, int pen_thickness, Color color_of_pen)
        {
            ...
            MarkPixelToChange(center_x, center_y, color_of_pen);
